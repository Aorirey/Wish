    ...
    <div className="mx-auto max-w-6xl space-y-8 px-4 py-10 md:px-8">
      ...
      {friends.length === 0 ? (
        <section className="card flex flex-col items-center gap-5 p-12 text-center">
          <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-ink-50 text-ink-600">
        ...
        <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
          {friends.map((f) => (
            ...
            >
              ...
              <div className="p-5">
                <p className="line-clamp-3 min-h-[3em] text-sm leading-relaxed text-ink-600">
                  {f.bio || "Без описания."}
                </p>
