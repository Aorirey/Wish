...
- **120 товаров** в **10 категориях** (Техника, Мода, Дом, Красота, Книги, Спорт, Кухня, Музыка, Детям, Игры).
...
- **10 пользователей** с биографиями и вишлистами (91 item в сиде).
- Цены в БД хранятся **в копейках** (`Int`) — надёжно и без float-ошибок. Функция `formatPrice` форматирует в «34 990 ₽».
...
| GET    | `/api/friends`                         | Все друзья с превью их вишлистов              |
